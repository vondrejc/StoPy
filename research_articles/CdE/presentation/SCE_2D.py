...
for quad_alternative in [Quad_Gauss(pchars=Q.pchars, p_int=15, name='Gauss'),
    ...
    sce=SimpleCE(Y=Y, E=E, yhat=y_true, quad=quad_alternative, theta=theta)
    mean_alternative=sce.mean(Q)
...
pl.ylabel(ylabel)
pl.legend(loc='best')
fname='figures/fig2d_apost1.pdf'
pl.savefig(fname, dpi=parf['dpi'], pad_inches=parf['pad_inches'], bbox_inches='tight')


pl.plot(phis[0](y_true)[0], phis[0](y_true)[1], '+r', label='$\Phi^1_{Q|Y_E}(\check{y})$ (Kalman filter)')
pl.legend(loc='best')
fname='figures/fig2d_apost2.pdf'
pl.savefig(fname, dpi=parf['dpi'], pad_inches=parf['pad_inches'], bbox_inches='tight')

pl.plot(phis[2](y_true)[0], phis[2](y_true)[1], 'xr', label='$\Phi^{10}_{Q|Y_E}(\check{y})$')
pl.legend(loc='best')
fname='figures/fig2d_apost3.pdf'
pl.savefig(fname, dpi=parf['dpi'], pad_inches=parf['pad_inches'], bbox_inches='tight')

pl.plot(mean[0], mean[1], 'ob', label='$\Phi_{Q|Y_E}(\check{y})$')
pl.legend(loc='best')
fname='figures/fig2d_apost4.pdf'
pl.savefig(fname, dpi=parf['dpi'], pad_inches=parf['pad_inches'], bbox_inches='tight')
